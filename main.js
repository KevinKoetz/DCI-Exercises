...
function checkNumber(number1, number2){
    let number1IsInRange = (number1 >= 40 && number1 <=60) || (number1 >= 70 && number1 <=100);
    let number2IsInRange = (number2 >= 40 && number2 <=60) || (number2 >= 70 && number2 <=100);
    let both = ((number1 >= 40 && number1 <=60) || (number1 >= 70 && number1 <=100)) && ((number2 >= 40 && number2 <=60) || (number2 >= 70 && number2 <=100))
    return both
