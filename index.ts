...
for (const key in person) {
  l(`Key: ${key}, Value: ${person[key as keyof Person]}`);
}
...
line();
const objectToArray = (obj: object) => Object.entries(obj);
...
/*   2. List Properties. Create a function that returns an array of properties of a javascript object.
  ...
  ["name", "class", "course"] */
line();
const getProperties = (obj: object) => Object.keys(obj);
...
{key: true} ➞ [["key"], [true]] */
line();
const getKeysAndValues = (obj: object) => [
  Object.keys(obj),
  Object.values(obj),
];
