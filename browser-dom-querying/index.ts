...
const menuHeadings = document.querySelectorAll<HTMLElement>(".category");
...
const foodCategory = document.querySelectorAll<HTMLElement>(".food-category");
...
const allergyInfos = document.querySelectorAll<HTMLLIElement>(".allergy-info");
...
const allergyWarning = document.querySelector<HTMLElement>(".allergy-warning");
if (allergyWarning) {
...
const foodDescs = document.querySelectorAll<HTMLElement>(".food-desc");
...
const footer = document.querySelector<HTMLLIElement>(".footer")
if(footer){
